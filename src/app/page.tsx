...
import ampLogo from '@/images/logos/amp.jpeg'


import image1 from '@/images/photos/mike-ryan.png'
import image2 from '@/images/photos/chess.png'
import image3 from '@/images/photos/mike-dana.png'
import image4 from '@/images/photos/mike-zach.png'
import image5 from '@/images/photos/flamethrower.png'
...
function Resume() {
  let resume: Array<Role> = [
    {
      company: 'Google',
      title: 'Ad Campaign Strategy, Web Development & Design, GTM Campaigns, Video Ad Production ',
      agency: ["R/GA", ""],
      logo: googleLogo,
      start: '2021',
      end: {
    ...
    {
      company: 'Nike',
      title: 'Campaign Strategy, Product Release Planning and Branding',
      agency: ["R/GA", ""],
      logo: nikeLogo,
      start: '2014',
      end: '2019',
    ...
    {
      company: 'Samsung',
      title: 'Campaign Strategy, GTM Campaigns, Product Release Branding',
      logo: samsungLogo,
      agency: ["R/GA", ""],
      start: '2011',
      end: '2014',
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            ...
            <SocialLink
              href="https://www.instagram.com/mickmath/"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/mickmath86"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/mmathias86/"
